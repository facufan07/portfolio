...
export default function ProyectFullDetails({ name, url, backgroundColor, 
    ...
    return createPortal(
        ...
        >
            ...
            >
                <div
                className={`${backgroundColor} w-4/5 h-5/6 overflow-y-auto rounded-lg 
                ...
                >
                    ...
                    >
                        <div
                        className="h-auto w-2/4 px-7"
                        >
                            <p
                            className={`${fontColor} text-3xl font-semibold tracking-widest`}
                            >
                                {description}
                            </p>

                            <h2
                            className={`${fontColor} text-4xl font-semibold tracking-widest mt-16 mb-7`}>
                                Desafio:
                            </h2>
                        ...
                        <div
                        className="h-auto w-2/4 flex flex-col items-center"
                        >
                            <Image
                            src={img}
                            width={200}
                            height={200}
                            alt="proyect image"
                            className="rounded-lg w-5/6 h-2/4 mb-8 shadow-lg shadow-black"
                            />

<div 
                            className="mb-16 w-full flex justify-center gap-5"
                            >
                                <a 
